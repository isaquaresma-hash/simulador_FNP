...
def set_bg_hack(main_bg):
    ...
    if bin_str:
        ...
        /* Nivelamento dos campos de filtro e ranking */
...
with f_col4:
    st.markdown('<div style="text-align: center;"><span class="badge-dark" style="margin-bottom: 6px;">Ranking</span></div>', unsafe_allow_html=True)
    st.markdown(f"""
